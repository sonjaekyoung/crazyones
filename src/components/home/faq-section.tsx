...
const FAQS: Record<Language, FaqItem[]> = {
  ...
  ko: [
    {
      q: "누가 들어갈 수 있나요?",
      a: "미친 사람.\n\n나이, 경력, 성과는 중요하지 않습니다. 대부분의 사람들이 불가능하다고 생각하는 일을 추구할 만큼 미친 사람입니다.\n\n똑똑한 사람은 흔합니다. 세상을 바꾸는 사람은 드뭅니다.",
    },
    {
      q: "어떻게 들어갈 수 있나요?",
      a: "현재는 추천을 통해서만 입주할 수 있습니다.\n\n모든 지원자는 두 번의 인터뷰를 거칩니다. 첫 번째는 광인회관에 거주 중인 창업자들과의 인터뷰이며, 만장일치로 승인되어야 합니다. 최종 인터뷰는 광인회관을 시작한 LINER의 창업자와 함께 진행됩니다.",
    },
    {
      q: "꼭 같이 살아야 하나요?",
      a: "네.\n\n광인회관은 미친 창업자들이 같이 살며 함께 꿈을 이루는 공간입니다.\n\n함께 살아야만 광인회관의 본질인 대화, 우정, 웅원이 만들어집니다. 오래 살 필요는 없지만, 모든 멤버는 함께 사는 것에서 시작합니다.",
    },
    {
      q: "몇 명이 함께 살고 있나요?",
      a: "8명의 창업자가 함께 삽니다.\n\n멤버들이 새로운 챕터로 나아가며 나가고, 새로운 창업자가 합류하면서 8명의 인원이 유지됩니다.",
    },
    {
      q: "비용은 얼마인가요?",
      a: "사용하게 될 방과 입주 시 거주 인원에 따라 다릅니다.\n\n선배들의 지원 덕분에 렌트비는 홍대 중심부 위치 대비 비교적 저렴하게 유지됩니다.",
    },
    {
      q: "가장 큰 가치는 무엇인가요?",
      a: "각자 느끼는 가치는 조금씩 다릅니다.\n\n평생의 우정이라고 말하는 사람도 있고, 멘토십, 재미라고 말하는 사람도 있습니다.\n\n하지만 확실한 건:\n\n미친 창업자들과 같이 살면, 당신의 꿈도 더 커집니다.",
    },
  ],
};
